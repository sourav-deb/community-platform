            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="setacc-process.php" method="post">
                            <h5 class="text-center text-white">Your Profile</h5>

                            <div class="form-group">
                                <label for="username" class="text-info">Email:</label><br>
                                <input type="email" name="email" id="email" class="form-control" placeholder="Enter Your Email" value="<?php echo $res['email']; ?>" disabled >
                            </div>

                            <div class="form-group">
                                <label for="Name" class="text-info">Name:</label><br>
                                <input type="text" name="name" id="name" class="form-control"  placeholder="Enter Your Name" value="<?php echo $res['name']; ?>" disabled>
                            </div>

                            <div class="form-group">
                                <label for="UserName" class="text-info">UserName:</label><br>
                                <input type="text" name="uname" id="uname" class="form-control"  placeholder="Enter Your UserName" value="<?php echo $res['uname']; ?>" disabled>
                            </div>

                            <div class="form-group">
                                <label for="Community" class="text-info">Community:</label><br>
                                <input type="text" name="community" id="community" class="form-control"  placeholder="Enter Your Community" value="<?php echo $res['community']; ?>" disabled>
                            </div>
